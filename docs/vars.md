...
* *kubelet_cpu_manager_policy_options* -  A dictionary of cpuManagerPolicyOptions to enable. Don't forget to enable the corresponding feature gates and make sure to pass the booleans as string (i.e. don't forget the quotes)!
